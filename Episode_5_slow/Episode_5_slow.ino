...
// adds slow motion to the servo
// can use myservo.write(angle) -90 to +90
// can also use writeMicroseconds(value) min to max, 500 to 2400 - allows much finer control

// servo connected to the LED output state as an example
// next step is a custom class that can support callbacks
